jQuery(document).ready(function($) {
    'use strict';
    var this_obj = political_campaign_plugin_activate_plugin;

    $('#gutenberg_editor .plugin-activation-redirect a').addClass('ive-redirect-to-dashboard');

    $(document).on('click', '.political-campaign-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message political-campaign-plugin-install');
                button.addClass('button-primary political-campaign-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.political-campaign-recommended-plugins .political-campaign-activation-note').css('display','block');
    ...
    $(document).on('click', '.political-campaign-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .political-campaign-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .political-campaign-recommended-plugins').css('display','none');
    });
