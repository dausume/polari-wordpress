...
class Political_Campaign_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
    ...
    public function render_content(){ ?>
        <label>
            ...
            <div class="social-icon-search">
                <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'political-campaign' ); ?>">
            </div>
            ...
            <ul class="icon-list clearfix">
                <?php
                $political_campaign_font_awesome_icon_array = political_campaign_font_awesome_icon_array();
                foreach ($political_campaign_font_awesome_icon_array as $political_campaign_font_awesome_icon) {
                        $icon_class = $this->value() == $political_campaign_font_awesome_icon ? 'icon-active' : '';
                        echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($political_campaign_font_awesome_icon).'"></i>
                        <span class="political-campaign-social-class">'.esc_attr($political_campaign_font_awesome_icon).'</span>
                        </li>';
                    }
                ?>
            </ul>
...
function political_campaign_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'political-campaign-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'political_campaign_customizer_script' );

if(!function_exists('political_campaign_font_awesome_icon_array')){
    function political_campaign_font_awesome_icon_array(){
