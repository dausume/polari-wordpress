...
class Political_Campaign_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Political_Campaign_About_Widget',
			__('VW About us', 'political-campaign'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'political-campaign' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','political-campaign'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','political-campaign'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','political-campaign'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','political-campaign'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','political-campaign'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','political-campaign'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function political_campaign_about_custom_load_widget() {
	register_widget( 'Political_Campaign_About_Widget' );
}
add_action( 'widgets_init', 'political_campaign_about_custom_load_widget' );